...
use Paho\Vinuva\Models\Pneumonia as BaseCase;
...
class Pneumonia extends BaseCase
{
    public function __construct(
        ...
        ?int $suspectedWith,
        ?Probable $probable,
        ?Probable $probableWithBlood,
        ?Probable $probableWithPleural,
        ?Confirmed $u12Confirmed,
        ?Confirmed $u23Confirmed,
        ?Confirmed $u59Confirmed,
        ?Confirmed $confirmed,
